    ...
    <div className="row align-items-center" >
      <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 wow fadeInRight">
        <div className="illustration-holder  pt-50 pb-50 pe-md-5 lg-mt-80"  >
          <img
            src="images/field/tabDashboard.png"
            alt=""
      ...
      <div className=" col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <div className="block-style-seven wow fadeInLeft">
          ...
          <p className="fs-20 pt-30 pb-30 lg-pb-20">
             Integration with Microsoft Dynamics 365 Field Service and Microsoft Dynamics 365 F&O 
             Asset Management is an important feature for field 
             service teams.
          </p>
